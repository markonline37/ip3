...
<script src="js/hearthstonetutorial.js"></script>
...
Links to further reading on relevant topics are available at the bottom of the page.<br><br>
...
When a user accesses the hearthstone visualisation page, the visualiser server sends the URL to the hearthstone API using an AJAX request using the API key as a custom header.<br><br>
...
In the following section we will process this data instead of logging it to console.<br><br>
...
And finally a chart object is made and bound to the div with element id 'chart_div' which is used to draw the chart using the data and options.<br><br>
