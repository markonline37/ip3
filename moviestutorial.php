...
<p>
	...
	the <a href="movies.php">movie visualization page</a>. <br><br>
...
<p>
	The visualization method used is <a href="https://cdnjs.cloudflare.com/ajax/libs/Chart.js/2.7.3/Chart.bundle.js">Chart.js</a>, a javascript library. It also has easy-to-understand <a href="https://www.chartjs.org/docs/latest/">documentation</a>. 
</p>
...
<p>
	...
	This allows us to use a stylesheet, the chart.js API, jquery, and a separate javascript file, which will help us work with the data and its visualization.<br>
</p>
...
<p>
	...
	The onclick attribute is used to specify the functions that are called in the javascript document linked to earlier. In these functions we will change the graph's data.<br>
</p>
<p>
	...
	The wrapper div is for css purposes, so it is not needed, but the chart should be in a canvas tag with an id.<br>
</p>
